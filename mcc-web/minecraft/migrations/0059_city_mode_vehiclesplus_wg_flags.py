...
def update_city_and_bootstrap_presets(apps, schema_editor):
...
def noop_reverse(apps, schema_editor):
    """Keep commands; reverting WG flags on live worlds is operator-driven."""


class Migration(migrations.Migration):

    dependencies = [
        ("minecraft", "0058_grant_catalog"),
    ]

    operations = [
        migrations.RunPython(update_city_and_bootstrap_presets, noop_reverse),
    ]
