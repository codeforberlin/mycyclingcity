...
Template tags for map app.
Provides formatting functions for map-related templates.
"""
...
def get_current_lang_code(context):
    """Get current language code from request context."""
    request = context.get('request')
    if request:
        return getattr(request, 'LANGUAGE_CODE', translation.get_language()) or 'de'
    return translation.get_language() or 'de'
