...
urlpatterns = [
    ...
    path('luanti/shop/sell_batch/', luanti_shop_sell_batch, name='luanti_shop_sell_batch'),
    ...
    path('luanti/player/pos/', luanti_player_pos, name='luanti_player_pos'),
